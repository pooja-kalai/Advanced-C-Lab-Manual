...
```
Output:
![image](https://github.com/user-attachments/assets/8a20af06-e3c6-4bb2-aabb-3d112f7e0ec5)
Result:
...
```
Output:
![image](https://github.com/user-attachments/assets/d8de3399-0593-4785-be62-c45db3c48716)
Result:
Thus, the program is verified successfully
...
```
Output:
![image](https://github.com/user-attachments/assets/445fecb4-d1d8-43f6-a39c-7c17cef4c070)
Result:
Thus, the program is verified successfully
...
```
Output:
![image](https://github.com/user-attachments/assets/fa36b504-8d28-41e4-853f-7c0213475f6c)
Result:
Thus, the program is verified successfully.
...
```
Output:
![image](https://github.com/user-attachments/assets/1d6eed73-b7ef-4170-8c8c-d59a730f3629)
Result:
Thus, the program is verified successfully
